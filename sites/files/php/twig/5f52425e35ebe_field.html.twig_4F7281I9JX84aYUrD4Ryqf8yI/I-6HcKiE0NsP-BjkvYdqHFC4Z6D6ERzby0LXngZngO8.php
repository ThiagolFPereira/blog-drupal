...
class __TwigTemplate_58c07d71c4b29157259a228aba54369311dd71d88f13f25af0cbf1f00722677e extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        $macros = $this->macros;
        // line 41
        $context["classes"] = [0 => "w3-section", 1 => "field", 2 => ("field--name-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(        // line 44
...
";
      ...
      ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 60
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 60), "addClass", [0 => "w3-bar-item field__item"], "method", false, false, true, 60), 60, $this->source), "html", null, true);
                    echo ">";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "w3-bar-item field__item"], "method", false, false, true, 65), 65, $this->source), "html", null, true);
                    echo ">";
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 75
                echo "      <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 75), "addClass", [0 => "w3-bar-item field__item"], "method", false, false, true, 75), 75, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return array (  162 => 80,  158 => 78,  155 => 77,  144 => 75,  139 => 74,  135 => 72,  133 => 71,  127 => 70,  122 => 69,  118 => 67,  107 => 65,  102 => 64,  98 => 62,  87 => 60,  83 => 59,  78 => 58,  75 => 57,  73 => 56,  70 => 55,  68 => 52,  67 => 50,  65 => 46,  64 => 45,  63 => 44,  62 => 41,);
    }

    public function getSourceContext()
    {
        return new Source("", "themes/d8w3css/templates/field/field.html.twig", "D:\\xampp\\htdocs\\drupal-bar-cat\\themes\\d8w3css\\templates\\field\\field.html.twig");
    }
}
